...
import psycopg2
from config import DB_CONFIG, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_PORT
import config
...
def index():
    ...
    return render_template('index.html',
                           ...
                           rate=current_rate)  # استخدام current_rate من قاعدة البيانات
...
def update_rate():
    ...
    try:
        ...
        # تحديث المتغير العام في config (اختياري)
...
if __name__ == '__main__':
    ...
    logging.info("🌐 بدأ تشغيل لوحة التحكم...")
    logging.info(f"🔗 رابط الوصول: http://{WEB_HOST}:{WEB_PORT}")
    logging.info(f"👤 اسم المستخدم: {WEB_USERNAME}")
