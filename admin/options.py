...
# ... (باقي دوال إضافة الخيار تبقى كما هي مع إضافة clear_cache في النهاية)
...
# ... (باقي دوال إضافة اللعبة الجديدة مع إضافة clear_cache في النهاية)
